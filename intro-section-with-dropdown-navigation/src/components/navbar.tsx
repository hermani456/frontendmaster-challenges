...
const Navbar = () => {
  return (
    <nav className="flex items-center gap-10 py-6 px-4">
      ...
      <menu className="flex items-center gap-6 text-lg">
        ...
        <li className="hover:font-semibold cursor-pointer text-gray-500 hover:text-black">Careers</li>
        <li className="hover:font-semibold cursor-pointer text-gray-500 hover:text-black">About</li>
      </menu>
