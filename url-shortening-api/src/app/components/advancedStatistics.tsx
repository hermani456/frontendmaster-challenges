import brandRecognitionIcon from "@/public/icon-brand-recognition.svg";
import detailedRecordsIcon from "@/public/icon-detailed-records.svg";
import fullyCustomizableIcon from "@/public/icon-fully-customizable.svg";
